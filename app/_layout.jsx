...
const Layout = () => {
  ...
  useEffect(() => {
    if (isRegistered === false) {
      ...
      // Redirige a la pantalla de inicio si el usuario está registrado
      console.log("Usuario registrado, redirigiendo a la pantalla de inicio");
      router.push("/BottomNavigator");  // Usa `replace` para reemplazar la entrada actual en el historial
    }
